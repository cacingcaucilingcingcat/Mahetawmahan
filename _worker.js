...
// Variables
const rootDomain = "cacingcaucilingcingcat.workers.dev"; // Ganti dengan domain utama kalian
const serviceName = "mahetawmahan"; // Ganti dengan nama workers kalian
...
function getAllConfig(request, hostName, proxyList, page = 0) {
  ...
  try {
    ...
    document.setTitle("CECEP RAHMAT'S <span class='text-blue-500 font-semibold'>PROJECT</span>");
